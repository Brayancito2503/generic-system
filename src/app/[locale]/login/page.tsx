...
import { PosPinLogin } from "@/features/auth/components/pos-pin-login";
...
export default function LoginPage() {
    ...
    return (
        <div className="relative flex min-h-screen w-full bg-background-light dark:bg-background-dark text-black dark:text-white overflow-hidden transition-colors duration-300">
            {/* LEFT BRAND */}
